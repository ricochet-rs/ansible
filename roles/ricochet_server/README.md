...
| `ricochet_package_url_base`                | `"https://ricochet-server.s3.eu-central-003.backblazeb2.com"`                 | Base URL for downloading ricochet-server OS packages.                                                                                                                                                                                          | `string` |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `ricochet_systemd_cleanup_match`           | `"^/usr/bin/ricochet start --config /var/lib/ricochet/ricochet-config.toml$"` | Regex used by pkill -f in the post-stop cleanup.                                                                                                                                                                                               | `string` |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `ricochet_systemd_cleanup_stale_processes` | `true`                                                                        | Run a post-stop cleanup to kill stale ricochet server processes that may<br />have escaped the service cgroup on previous runs.                                                                                                                | `bool`   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `ricochet_systemd_disable_delegate`        | `true`                                                                        | Disable cgroup delegation in the packaged unit to avoid leaked child processes<br />surviving service restarts and keeping listener ports bound.                                                                                               | `bool`   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `ricochet_systemd_timeout_stop_sec`        | `120`                                                                         | Stop timeout for ricochet-server.service in systemd mode.                                                                                                                                                                                      | `int`    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `ricochet_version`                         | `"0.14.1"`                                                                    | Version of ricochet-server to install.<br />Used as the package version (systemd mode) or image tag (docker mode).                                                                                                                             | `string` | `"\"0.1.0\""`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
